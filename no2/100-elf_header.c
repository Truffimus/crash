...
#include <unistd.h>
/**
* _strncmp - compares the two strings
* @s1: first string
* @s2: second string
* @n: max num of bytes to be compared
*
* Return: if first n bytes of string2 and string1 are equal 0, if not non zero
*/
...
/**
* _close - closes the file descriptor also prints error mesege if it fails
...
/**
* _read - reads file also prints error mesege if it fails
* @fd: file descriptor to be read
* @buf: buffer writen to
* @count: num of bytes to be readen
*/
...
/**
* elf_osabi - prints the elf OS or ABI
* @buffer: header of elf
*/
...
/**
* elf_entry - prints the address of the entry point
* @buffer: string with the address of the entry point
...
/**
* main - copies the contents of a into another file
